...
msbuild node.sln %msbcpu% /t:%target% /p:Configuration=%config% /p:Platform=%msbplatform% /clp:NoSummary;NoItemAndPropertyList;Verbosity=minimal /nologo /clp:Verbosity=m;ShowCommandLine;ShowTimestamp /fl1 /fl2 /fl3 /flp2:logfile=JustErrors.log;errorsonly /flp3:logfile=JustWarnings.log;warningsonly /flp1:DisableMPLogging;ForceNoAlign;ShowCommandLine;ShowTimestamp;LogFile=node.build.log
